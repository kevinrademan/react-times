...
var pickerPointGenerator = function pickerPointGenerator() {
  ...
  return function (_React$Component) {
    _inherits(PickerPointGenerator, _React$Component);

    function PickerPointGenerator(props) {
      _classCallCheck(this, PickerPointGenerator);

      var _this = _possibleConstructorReturn(this, (PickerPointGenerator.__proto__ || Object.getPrototypeOf(PickerPointGenerator)).call(this, props));

      _this.handleTimePointerClick = props.handleTimePointerClick.bind(_this);
      return _this;
    }
    ...
    _createClass(PickerPointGenerator, [{
      ...
      value: function addAnimation() {
        _reactDom2.default.findDOMNode(this.pickerPointerContainer).className = "animation";
      }
    }, {
      key: 'removeAnimation',
      value: function removeAnimation() {
        _reactDom2.default.findDOMNode(this.pickerPointerContainer).className = "";
      }
    }, {
        ...
        return _ConstValue.MINUTES.map(function (m, index) {
          ...
          if (index % 5 === 0) {
            return _react2.default.createElement(_PickerPoint2.default, {
              ...
              key: index,
              angle: angle,
              handleTimeChange: _this2.handleTimePointerClick
            });
          }
        });
      }
      ...
      value: function renderHourPointes() {
        ...
        var hours = parseInt(mode) === 24 ? _ConstValue.HOURS : _ConstValue.TWELVE_HOURS;
        return hours.map(function (h, index) {
          ...
          return _react2.default.createElement(_PickerPoint2.default, {
            ...
            handleTimeChange: _this3.handleTimePointerClick
          });
        });
      }
    }, {
